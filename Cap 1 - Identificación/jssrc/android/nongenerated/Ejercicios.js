...
function inicializarMfCliente() {
    ...
    */
    ...
    konyMobileFabric.init(appkey, appsecret, serviceurl, fnInicializacionOK, /*getlogin,*/ fnInicializacionError);
...
function getlogin() { //Esta funcion debe retornar el token de la conexion
    ...
    */
    ...
    if (statusMF === true) {
        ...
        authClient.login({
                "userid": "diego.ariza@accenture.com", //Usuario
                "password": "Mp933asd-"
            }, //Contraseña
            fnLoginExitoso, fnLoginError);
...
function getLogout() {
    ...
    */
    konyMobileFabric.logout(fnlogoutExitoso, fnlogoutError);
}
